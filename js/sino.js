...
$(document).ready(function(){
    ...
    //显示
    $(".voiceStar").on("click",function(){
        $(".openVoice").fadeIn(200);
        $(".openVoice-box").fadeIn(200);
    });

    //隐藏
    $(".openVoice").on("click",function(){
        $(".openVoice").fadeOut(200);
        $(".openVoice-box").fadeOut(200);
        setTimeout(function(){
            $(".openVoice-icon a").removeClass();
            $(".openVoice-icon a").addClass("star");
            $(".openVoice-btns").hide();
        },200);
    });
    ...
    //录音
    $(".openVoice-icon a").on("click",function(){
    ...
    //完成
    $(".openVoice-btns ul li a").on("click",function(){
    ...
    //补充页面
    $(".suplist .item .head .user").on("click",function(){
        if(!$(this).parents(".suplist").hasClass("suplist2")){
            if($(this).parents(".item").hasClass("itemon")){
                $(".suplist .item").removeClass("itemon");
            }else{
                $(".suplist .item").removeClass("itemon");
    ...
    $(".suplist .item .head .other .arr a").on("click",function(){
        if($(this).parents(".item").hasClass("itemon")){
            $(".suplist .item").removeClass("itemon");
        }else{
            $(".suplist .item").removeClass("itemon");
    ...
    //新语音播放
    $(".finenewmusic-btn a ").on("click",function(){
        if($(this).hasClass("on")){
            //停止播放
            $(this).removeClass("on");
        }else{
